    ...
    companion object {
        ...
        val overlayDismissButtonSizeDP: Float
            get() {
                ...
                return SettingsHelper.getFloatSetting("misc", "overlayDismissButtonSizeDP", defaultValue)
            }
        ...
        val enableScreenRecording: Boolean
            get() = SettingsHelper.getBooleanSetting("debug", "enableScreenRecording", false)

        val recordingBitRate: Int
            get() {
                val storedValue = SettingsHelper.getIntSetting("debug", "recordingBitRate", 6)
                return if (storedValue <= 100) storedValue * 1_000_000 else storedValue
            }

        val recordingFrameRate: Int
            get() = SettingsHelper.getIntSetting("debug", "recordingFrameRate", 30)
